...
subtitle: "Preprocess BDR DNA methylation data"
author:
...
dnam_data <- create_summarized_experiment(
  pheno_df, assay_data, array = "EPIC", genome = "hg19"
)
...
df_distribution <- data.frame(
  statistic = c(
    ...
    "Capped age at death (mean)",
    "Capped age at death (sd)",
  ...
  value = c(
    ...
    round(mean(dnam_data$age_adjusted), 2),
    round(stats::sd(dnam_data$age_adjusted), 2),
